...
const SquidWidget = ({ fromChainId, toChainId, fromTokenAddress, toTokenAddress }: SwapParams) => {
  ...
  return <iframe title="squid_widget" className="h-[684px] w-[450px]" src={iframeUrl} />;
};
